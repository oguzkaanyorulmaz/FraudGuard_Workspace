...
export const TransactionDetailsSidebar: React.FC<Props> = ({ transaction, isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Yan Panel */}
            <div 
                className={`fixed inset-y-0 right-0 w-full md:w-[600px] bg-white border-l border-[#E4E7EB] shadow-2xl z-50 transition-transform duration-300 ease-out flex flex-col ${
                    ...
                    {loading ? (
                        ...
                        (() => {
                            ...
                            <div className="space-y-4">
                                ...
                                {isTransfer ? (
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB] col-span-2">
                                            <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Gönderen IBAN</span>
                                            <span className="font-mono text-[#111] font-semibold text-xs md:text-sm">{detail.senderIBAN}</span>
                                        </div>
                                        <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB] col-span-2">
                                            <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Alıcı IBAN</span>
                                            <span className="font-mono text-[#111] font-semibold text-xs md:text-sm">{detail.receiverIBAN}</span>
                                        </div>
                                        <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                            <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Alıcı Adı Soyadı</span>
                                            <span className="font-bold text-slate-800 text-xs md:text-sm">{detail.receiverName || 'Bilinmiyor'}</span>
                                        </div>
                                        <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                            <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">İşlem ID</span>
                                            <span className="font-mono text-[#111] font-semibold">#{detail.transactionId}</span>
                                        </div>
                                        {detail.description && (
                                            <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB] col-span-2">
                                                <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Transfer Açıklaması</span>
                                                <span className="text-xs text-slate-700 italic">"{detail.description}"</span>
                                            </div>
                                        )}
                                    </div>
                                ) : (
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                            ...
                                            <span className="font-mono text-[#111] font-semibold">{formatCardNumber(detail.maskedCardNumber)}</span>
                                        </div>
                                        <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                            <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">İşlem ID</span>
                                            <span className="font-mono text-[#111] font-semibold">#{detail.transactionId}</span>
                                ...
                                <h3 className="text-[#111] font-bold text-xs uppercase tracking-wider mt-6 mb-3 border-b border-[#E4E7EB] pb-2">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                        ...
                                        <span className="text-xs font-semibold text-[#1A1D20]">{formatPhoneNumber(detail.phoneNumber)}</span>
                                    </div>
                                    {!isTransfer && detail.cardLimit > 0 ? (
                                        <>
                                            <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                                <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Kart Limiti</span>
                                                <span className="text-xs font-bold text-[#1A1D20]">{detail.cardLimit.toLocaleString('tr-TR')} TL</span>
                                            </div>
                                            <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                                <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Kalan Limit</span>
                                                <span className="text-xs font-bold text-[#1A1D20]">{detail.availableLimit.toLocaleString('tr-TR')} TL</span>
                                            </div>
                                            <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB] col-span-2">
                                                <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Kart Durumu</span>
                                        ...
                                        <>
                                            <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                                <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Hesap Bakiyesi</span>
                                                <span className="text-xs font-bold text-[#1A1D20]">{detail.availableLimit.toLocaleString('tr-TR')} TL</span>
                                            </div>
                                            <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                                <span className="text-[10px] text-[#718096] font-bold uppercase tracking-wider block mb-1">Hesap Durumu</span>
                                                <span className="text-xs font-bold text-[#1A1D20]">
                                                    {detail.isCardBlocked ? '⚠️ Blokeli' : (detail.isCardSuspicious ? '⚠️ Şüpheli' : '✅ Aktif')}
                                                </span>
                                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="bg-white p-3.5 rounded-lg border border-[#E4E7EB]">
                                        ...
                                        <span className="text-xs font-semibold text-[#1A1D20]">{new Date(detail.transactionDate).toLocaleDateString('tr-TR')} {new Date(detail.transactionDate).toLocaleTimeString('tr-TR', { hour: '2-digit', minute: '2-digit' })}</span>
                                    </div>
                                </div>

                                {/* KARTIN/HESABIN YAPTIĞI SON 10 İŞLEM LİSTESİ */}
                                <div className="mt-6 border-b border-[#E4E7EB] pb-2 flex flex-col gap-2">
                                    <h3 className="text-[#111] font-bold text-xs uppercase tracking-wider">
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        <button 
                                            ...
                                            className={`px-2.5 py-1 rounded text-[10px] font-bold border transition-all cursor-pointer ${historyTab === 'all' ? 'bg-[#FFC72C] text-[#111] border-[#FFC72C]' : 'bg-white text-slate-500 border-slate-200 hover:text-[#111] hover:border-[#FFC72C]'}`}
                                        >
                                            📋 Tüm İşlemler (Son 10)
                                        </button>
                                        <button 
                                            ...
                                            className={`px-2.5 py-1 rounded text-[10px] font-bold border transition-all cursor-pointer ${historyTab === 'suspicious' ? 'bg-[#FFC72C] text-[#111] border-[#FFC72C]' : 'bg-white text-slate-500 border-slate-200 hover:text-[#111] hover:border-[#FFC72C]'}`}
                                        >
                                        ...
                                        {detail.paymentTypeCode !== 'CreditCard' && (
                                            <button 
                                                ...
                                                className={`px-2.5 py-1 rounded text-[10px] font-bold border transition-all cursor-pointer ${historyTab === 'sent' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-slate-500 border-slate-200 hover:text-blue-600 hover:border-blue-600'}`}
                                            >
                                                📤 Gönderilen (Son 10)
                                            </button>
                                        )}
                                        {detail.paymentTypeCode !== 'CreditCard' && (
                                            <button 
                                                ...
                                                className={`px-2.5 py-1 rounded text-[10px] font-bold border transition-all cursor-pointer ${historyTab === 'received' ? 'bg-emerald-600 text-white border-emerald-600' : 'bg-white text-slate-500 border-slate-200 hover:text-emerald-600 hover:border-emerald-600'}`}
                                            >
                                                📥 Alınan (Son 10)
                                            </button>
                                        )}
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            {(() => {
                                                                ...
                                                                if (code === 'CreditCard') {
                                                                    return (
                                                                        <span className="bg-[#FFC72C] text-[#111] px-2.5 py-1 rounded-lg text-[9px] font-extrabold uppercase tracking-wider shadow-sm">
                                                                            Kredi Kartı
                                                                        </span>
                                                                    );
                                                                }
                                                                if (code === 'DebitCard') {
                                                                    return (
                                                                        <span className="bg-slate-700 text-white px-2.5 py-1 rounded-lg text-[9px] font-extrabold uppercase tracking-wider shadow-sm">
                                                                            Banka Kartı
                                                                        </span>
                                                                    );
                                                                }
                                                                if (code === 'BankTransfer' || code === 'EFT') {
                                                                    ...
                                                                    return (
                                                                        <span className={`px-2.5 py-1 rounded-lg text-[9px] font-extrabold uppercase tracking-wider shadow-sm text-white ${isOutgoing ? 'bg-blue-600' : 'bg-emerald-600'}`}>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            {/* Status Badge */}
                                                            <span className={`px-2.5 py-0.5 rounded-full border text-[9px] font-bold inline-flex items-center gap-1 ${
                                                                tx.status === 'Approved' 
                                                    ...
                                                    {isExpanded && (
                                                        ...
                                                        >
                                                            <div className="grid grid-cols-2 gap-3 bg-slate-50/50 p-1.5 rounded-xl">
                                                                {isTxTransfer ? (
                                                                    <>
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Gönderen IBAN</span>
                                                                            <span className="font-mono text-slate-800 text-xs">{tx.senderIBAN}</span>
                                                                        </div>
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Alıcı IBAN</span>
                                                                            <span className="font-mono text-slate-800 text-xs">{tx.receiverIBAN}</span>
                                                                        </div>
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Alıcı Adı Soyadı</span>
                                                                            <span className="font-bold text-slate-800 text-xs">{tx.receiverName || 'Bilinmiyor'}</span>
                                                                        </div>
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">İşlem Tipi</span>
                                                                            <span className="font-semibold text-slate-800 text-xs md:text-sm">{tx.transactionTypeName}</span>
                                                                        </div>
                                                                        {tx.description && (
                                                                            <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                                <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Açıklama</span>
                                                                                <span className="text-slate-700 text-xs italic">"{tx.description}"</span>
                                                                            </div>
                                                                        )}
                                                                    </>
                                                                ) : (
                                                                    <>
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Kart No</span>
                                                                            <span className="font-semibold text-slate-800 text-xs md:text-sm">{formatCardNumber(detail.maskedCardNumber)}</span>
                                                                        </div>
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">İşlem Tipi</span>
                                                                            <span className="font-semibold text-slate-800 text-xs md:text-sm">{tx.transactionTypeName}</span>
                                                                        ...
                                                                        <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                            <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Kategori</span>
                                                                            <span className="font-semibold text-slate-800 text-xs md:text-sm">{tx.merchantCategory || 'Bilinmiyor'}</span>
                                                                        </div>
                                                                    </>
                                                                )}
                                                                ...
                                                                {/* Lokasyon */}
                                                                <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                    <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Lokasyon</span>
                                                                    <span className="font-semibold text-slate-800 text-xs md:text-sm">{tx.location}, {tx.country}</span>
                                                                </div>

                                                                {/* Tarih & Saat */}
                                                                <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                    <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">İşlem Zamanı</span>
                                                                ...
                                                                {/* Durum */}
                                                                <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm">
                                                                    <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">İşlem Durumu</span>
                                                                ...
                                                                {tx.declineReason && (
                                                                    <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                        <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Red Sebebi</span>
                                                                        <span className="font-bold text-red-600 text-xs md:text-sm">{tx.declineReason}</span>
                                                                    </div>
                                                                )}
                                                                ...
                                                                {tx.fraudSuspicionReason && (
                                                                    <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                        <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Şüphe Sebebi</span>
                                                                        <span className="font-bold text-amber-600 text-xs md:text-sm">{tx.fraudSuspicionReason}</span>
                                                                    </div>
                                                                )}
                                                                ...
                                                                {tx.adminNote && (
                                                                    <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                        <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Analist Gerekçe Notu</span>
                                                                        <span className="font-semibold text-slate-700 text-xs">{tx.adminNote}</span>
                                                                    </div>
                                                                )}
                                                                ...
                                                                {tx.resolvedByAdmin && (
                                                                    <div className="bg-white p-3 rounded-xl border border-[#E4E7EB] shadow-sm col-span-2">
                                                                        <span className="text-[9px] text-[#718096] font-extrabold uppercase tracking-wider block mb-1">Aksiyonu Alan Analist</span>
                                                                        <span className="font-semibold text-slate-800 text-xs">{tx.resolvedByAdmin}</span>
                                                                    </div>
                                                                )}
                                                            </div>
                                                        </div>

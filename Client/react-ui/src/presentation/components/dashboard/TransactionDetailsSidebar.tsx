                ...
                <div className="p-6 flex-1 overflow-y-auto">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="mt-6 border-b border-[#E4E7EB] pb-2 flex justify-between items-center">
                                <h3 className="text-[#111] font-bold text-xs uppercase tracking-wider">Kart Geçmişi</h3>
                                <div className="flex gap-2">
                                    ...
                                    <button 
                                        type="button"
                                        onClick={() => setHistoryTab('suspicious')} 
                            ...
                            <div className="space-y-3 mt-3">
                                {((historyTab === 'all' ? detail.recentTransactions : detail.recentSuspiciousTransactions) || []).length > 0 ? (
                                    ((historyTab === 'all' ? detail.recentTransactions : detail.recentSuspiciousTransactions) || []).map((tx: any, idx: number) => {
                                        const isExpanded = expandedTxId === idx;
                                        const hasMeta = detail.maskedCardNumber && detail.maskedCardNumber.length >= 4;
                                        const metaInfo = hasMeta ? `•••• ${detail.maskedCardNumber.slice(-4)}` : 'Kart';
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        {(() => {
                                                            ...
                                                            if (code === 'BankTransfer' || code === 'EFT') {
                                                                return (
                                                                    <span className="bg-blue-600 text-white px-2.5 py-1 rounded-lg text-[9px] font-extrabold uppercase tracking-wider shadow-sm">
                                                                        EFT/Havale
                                                                    </span>
                                                                );
                                                            }

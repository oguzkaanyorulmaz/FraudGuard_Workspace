...
export const theme = {
    ...
    styles: {
        ...
        tabContainer: "flex gap-3 md:gap-5 border-b border-[#E4E7EB] pb-0 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden",
        tabActive: "px-2 py-2.5 md:py-3 text-xs md:text-sm font-bold text-[#111] border-b-4 border-[#FDBB30] transition-all relative top-[1px] whitespace-nowrap flex-shrink-0",
        tabInactive: "px-2 py-2.5 md:py-3 text-xs md:text-sm font-semibold text-[#718096] hover:text-[#111] transition-all whitespace-nowrap flex-shrink-0",
